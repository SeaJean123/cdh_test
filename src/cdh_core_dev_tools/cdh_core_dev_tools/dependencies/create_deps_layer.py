...
class FileMaker:
    ...
    def _fetch_requirements_docker(cls, tmp_dir: str, file_name: Path, requirements_file_path_name: str) -> str:
        ...
        try:
            ...
            docker_build_command = (
                f"DOCKER_BUILDKIT=1 docker build --progress=plain --pull {requirements_path} "
    ...
    def make_file(  # pylint: disable=too-many-arguments
        self,
        tmp_dir: str,
...
def generate_and_upload_new_zip_file(  # pylint: disable=too-many-arguments
    s3_resource: Any,
    requirements_file_path_name: str,
    bucket_name: str,
    zip_file: Optional[str],
